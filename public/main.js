...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\r\n\r\n<div class=\"app-body\">\r\n  <main class=\"main d-flex align-items-center\">\r\n    <div class=\"container\">\r\n      <div class=\"row\">\r\n        <div class=\"col-md-8 mx-auto\">\r\n          <div class=\"card-group\">\r\n            <div class=\"card p-4\">\r\n              <div class=\"card-body\">\r\n                <form [formGroup]=\"loginForm\" (ngSubmit)=\"onSubmit()\">\r\n                  <h1>Login</h1>\r\n                  <p class=\"text-muted\">Sign In to your account</p>\r\n                  <div class=\"input-group mb-3\">\r\n                    <div class=\"input-group-prepend\">\r\n                      <span class=\"input-group-text\"><i class=\"icon-user\"></i></span>\r\n                    </div>\r\n                    <input type=\"text\" class=\"form-control\" placeholder=\"Email or Username\" \r\n                      autocomplete=\"username\" required  formControlName=\"username\" [ngClass]=\"{ 'is-invalid': submitted && f.username.errors }\" >\r\n                    <div *ngIf=\"submitted && f.username.errors\" class=\"invalid-feedback\">\r\n                      <div *ngIf=\"f.username.errors.required\">Email or Username is required</div>\r\n                  </div>\r\n                  </div>\r\n                  <div class=\"input-group mb-4\">\r\n                    <div class=\"input-group-prepend\">\r\n                      <span class=\"input-group-text\"><i class=\"icon-lock\"></i></span>\r\n                    </div>\r\n                    <input type=\"password\" class=\"form-control\" placeholder=\"Password\" \r\n                      autocomplete=\"current-password\" required formControlName=\"password\" [ngClass]=\"{ 'is-invalid': submitted && f.password.errors }\" >\r\n                    <div *ngIf=\"submitted && f.password.errors\" class=\"invalid-feedback\">\r\n                      <div *ngIf=\"f.password.errors.required\">Password is required</div>\r\n                  </div>\r\n                  </div>\r\n                  <div class=\"row\">\r\n                    <div class=\"col-md-12\" *ngIf=\"error\">\r\n                      <div *ngIf=\"error\" class=\"alert alert-danger\">{{error}}</div>\r\n                    </div>\r\n                    <div class=\"col-6\">\r\n                      <button type=\"submit\" class=\"btn btn-primary px-4\" [disabled]=\"loading\" >\r\n                        <span *ngIf=\"loading\" class=\"spinner-border spinner-border-sm mr-1\"></span>\r\n                        Login\r\n                      </button>\r\n                    </div>\r\n         \r\n                    <div class=\"col-6 text-right\">\r\n                      <button type=\"button\" class=\"btn btn-link px-0\">Forgot password?</button>\r\n                    </div>\r\n                  </div>\r\n                </form>\r\n              </div>\r\n            </div>\r\n            <div class=\"card text-white bg-primary py-5 d-md-down-none\" style=\"width:44%\">\r\n              <div class=\"card-body text-center\">\r\n                <div>\r\n                  <h2>Sign up</h2>\r\n                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>\r\n                  <button type=\"button\" class=\"btn btn-primary active mt-3\" (click)=\"goToPage('register')\">Register Now!</button>\r\n                </div>\r\n              </div>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </main>\r\n</div>\r\n");
...
/* harmony import */ var _views_helpers_jwt_interceptor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/_helpers/jwt.interceptor */ "./src/app/views/_helpers/jwt.interceptor.ts");
/* harmony import */ var _views_helpers_error_interceptor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./views/_helpers/error.interceptor */ "./src/app/views/_helpers/error.interceptor.ts");
/* harmony import */ var _views_helpers_app_initializer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./views/_helpers/app.initializer */ "./src/app/views/_helpers/app.initializer.ts");
/* harmony import */ var _views_services_authentication_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./views/_services/authentication.service */ "./src/app/views/_services/authentication.service.ts");
    ...
    AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [{
                ...
                { provide: _angular_core__WEBPACK_IMPORTED_MODULE_2__["APP_INITIALIZER"], useFactory: _views_helpers_app_initializer__WEBPACK_IMPORTED_MODULE_7__["appInitializer"], multi: true, deps: [_views_services_authentication_service__WEBPACK_IMPORTED_MODULE_8__["AuthenticationService"]] },
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HTTP_INTERCEPTORS"], useClass: _views_helpers_jwt_interceptor__WEBPACK_IMPORTED_MODULE_5__["JwtInterceptor"], multi: true },
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HTTP_INTERCEPTORS"], useClass: _views_helpers_error_interceptor__WEBPACK_IMPORTED_MODULE_6__["ErrorInterceptor"], multi: true },
            ],
...
/* harmony import */ var _app_views_login_login_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../app/views/login/login.component */ "./src/app/views/login/login.component.ts");
...
/* harmony import */ var _views_helpers_auth_guard__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./views/_helpers/auth.guard */ "./src/app/views/_helpers/auth.guard.ts");
...
var routes = [
    ...
    { path: 'login', component: _app_views_login_login_component__WEBPACK_IMPORTED_MODULE_6__["LoginComponent"] },
    {
        path: '',
        // component: DashboardComponent,
        canActivate: [_views_helpers_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]],
    ...
    {
        path: 'login',
        component: _app_views_login_login_component__WEBPACK_IMPORTED_MODULE_6__["LoginComponent"],
        data: {
            title: 'Login Page'
        }
    },
...
/* harmony import */ var _views_services_authentication_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../views/_services/authentication.service */ "./src/app/views/_services/authentication.service.ts");




var DefaultLayoutComponent = /** @class */ (function () {
    function DefaultLayoutComponent(_authenticationService) {
        var _this = this;
        this._authenticationService = _authenticationService;
        this.sidebarMinimized = false;
        this.navItems = _nav__WEBPACK_IMPORTED_MODULE_2__["navItems"];
        this._authenticationService.currentUser.subscribe(function (x) { return _this._user = x; });
    }
    ...
    DefaultLayoutComponent.ctorParameters = function () { return [
        { type: _views_services_authentication_service__WEBPACK_IMPORTED_MODULE_3__["AuthenticationService"] }
    ]; };
    DefaultLayoutComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        ...
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_views_services_authentication_service__WEBPACK_IMPORTED_MODULE_3__["AuthenticationService"]])
...
/***/ "./src/app/views/_helpers/app.initializer.ts":
/*!***************************************************!*\
  !*** ./src/app/views/_helpers/app.initializer.ts ***!
  \***************************************************/
...
/***/ "./src/app/views/_helpers/auth.guard.ts":
/*!**********************************************!*\
  !*** ./src/app/views/_helpers/auth.guard.ts ***!
  \**********************************************/
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        ...
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            _views_services_authentication_service__WEBPACK_IMPORTED_MODULE_3__["AuthenticationService"]])
    ], AuthGuard);
    return AuthGuard;
}());
...
/***/ "./src/app/views/_helpers/error.interceptor.ts":
/*!*****************************************************!*\
  !*** ./src/app/views/_helpers/error.interceptor.ts ***!
  \*****************************************************/
...
/* harmony import */ var _views_services_authentication_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../views/_services/authentication.service */ "./src/app/views/_services/authentication.service.ts");
...
var ErrorInterceptor = /** @class */ (function () {
    ...
    ErrorInterceptor.prototype.intercept = function (request, next) {
        ...
        return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            if ([401, 403].includes(err.status) && _this.authenticationService.currentUserValue) {
    ...
    ErrorInterceptor.ctorParameters = function () { return [
        { type: _views_services_authentication_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticationService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
    ]; };
    ErrorInterceptor = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_views_services_authentication_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticationService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
    ], ErrorInterceptor);
...
/***/ "./src/app/views/_helpers/jwt.interceptor.ts":
/*!***************************************************!*\
  !*** ./src/app/views/_helpers/jwt.interceptor.ts ***!
  \***************************************************/
...
/***/ "./src/app/views/_services/authentication.service.ts":
/*!***********************************************************!*\
  !*** ./src/app/views/_services/authentication.service.ts ***!
  \***********************************************************/
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.login = function (userName, password) {
        var _this = this;
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + "/api/Authenticate/authenticate", { userName: userName, password: password }, { withCredentials: true })
            ...
            _this.currentUserSubject.next(Users);
            _this.startRefreshTokenTimer();
            return Users;
        }));
    };
    AuthenticationService.prototype.logout = function () {
        this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + "/api/Authenticate/revoke-token", {}, { withCredentials: true }).subscribe();
    ...
    AuthenticationService.prototype.refreshToken = function () {
        var _this = this;
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + "/api/Authenticate/refresh-token", {}, { withCredentials: true })
    ...
    AuthenticationService.prototype.startRefreshTokenTimer = function () {
        ...
        var jwtToken = JSON.parse(atob(this.currentUserValue.jwtToken.split('.')[1]));
...
/* harmony import */ var _services_authentication_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../_services/authentication.service */ "./src/app/views/_services/authentication.service.ts");
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(_router, _formBuilder, _route, _authenticationService) {
    ...
    LoginComponent.prototype.goToPage = function (pageName) {
...
module.exports = __webpack_require__(/*! C:\Users\repos\FixPay\FixPay.Apis\AdminPanel\src\main.ts */"./src/main.ts");
